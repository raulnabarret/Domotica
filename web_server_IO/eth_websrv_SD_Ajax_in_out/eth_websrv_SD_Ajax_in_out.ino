...
IPAddress ip(10, 32, 164, 170);                       //Direccion IP a asignar dentro de la red en la que se encuentra
...
void XML_response(EthernetClient cl)
{
    ...
    // A2 to A5
        ...
        if(analog_val <= 600 && analog_val >= 541){
            cl.print("<analog>");
            cl.print("100%");
            cl.println("</analog>");
        }
        else if(analog_val <= 540 && analog_val >= 481){
            cl.print("<analog>");
            cl.print("90%");
            cl.println("</analog>");
        }
        else if(analog_val <= 480 && analog_val >= 421){
            cl.print("<analog>");
            cl.print("80%");
            cl.println("</analog>");
        }
        else if(analog_val <= 420 && analog_val >= 361){
            cl.print("<analog>");
            cl.print("70%");
            cl.println("</analog>");
        }
        else if(analog_val <= 360 && analog_val >= 301){
            cl.print("<analog>");
            cl.print("60%");
            cl.println("</analog>");
        }
        else if(analog_val <= 300 && analog_val >= 241){
            cl.print("<analog>");
            cl.print("50%");
            cl.println("</analog>");
        }
        else if(analog_val <= 240 && analog_val >= 181){
            cl.print("<analog>");
            cl.print("40%");
            cl.println("</analog>");
        }
        else if(analog_val <= 180 && analog_val >= 121){
            cl.print("<analog>");
            cl.print("30%");
            cl.println("</analog>");
        }
        else if(analog_val <= 120 && analog_val >= 61){
            cl.print("<analog>");
            cl.print("20%");
            cl.println("</analog>");
        }
        else if(analog_val <= 60 && analog_val >= 1){
            cl.print("<analog>");
            cl.print("10%");
            cl.println("</analog>");
        }
